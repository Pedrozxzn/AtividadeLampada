...
const calcular = () => {
  ...
  // inValorPedido.value = 0.005
  // inPercDesc.value = 0.01
  // inValFinal.value = 0.015
  // inValPercDesc.value = 0.008
  ...
  //   }else if (inValorPedido){
  //   //   inPercDesc.value = 0.5
  //   // }

  // if (inValorPedido >= 2000) {
  //   inPercDesc.value = 1.5;
  inValDesc.value = inValorPedido * (inPercDesc / 100);
  ...
  // let valorDoPedido = document.getElementById("valorDoPedido")
  // console.log(`O valor de seu pedido foi de 700` ? [valorDoPedido < 0.5] : 700 - 0.5 )
};
const validaForm = () => {
  // captura dos dados
